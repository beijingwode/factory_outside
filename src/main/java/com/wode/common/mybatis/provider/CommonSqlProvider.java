package com.wode.common.mybatis.provider;
...
import com.wode.common.mybatis.EntityHelper;
...
public class CommonSqlProvider extends BaseProvider{
	...
	public String findEntityListByDataScope(final Map<String, Object> params){
		...
		return new SQL(){{
            ...
            com.wode.common.mybatis.EntityHelper.EntityTable entityTable = EntityHelper.getEntityTable(entityClass);
            SELECT(com.wode.common.mybatis.EntityHelper.getAllColumns(entityClass));
